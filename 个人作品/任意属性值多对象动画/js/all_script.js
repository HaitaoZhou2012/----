window.onload = function(){
	...
	for(var i=0; i<lis.length; i++){
		...
		//透明度变化
		/*lis[i].alpha = 30;//为每个lis对象定义一个alpha透明度
		lis[i].onmouseover = function(){
			startAct(this,"alpha",100);
		}
		//鼠标离开改变透明度
		lis[i].onmouseout = function(){
			startAct(this,"alpha",30);
		}*/
	}

}

function startAct(obj,type,iTarget){//obj指作用对象，type指被改变的属性，ITarget指改变的目标值
	//初始化清除定时器
